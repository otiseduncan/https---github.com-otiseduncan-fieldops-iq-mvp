...
function App() {
  ...
  useEffect(() => {
    ...
    const fetchJobs = async () => {
      // ONLY FETCH JOBS THAT ARE NOT ARCHIVED
  ...
  // ADDED: Real archive logic that updates the database
  const archiveAllCompleted = async () => {
    ...
    // Update each job to archived: true in Supabase
      ...
      {!session ? (
        ...
        <Layout role={role}>
          <Routes>
            ...
            {/* ADDED: archiveAllCompleted passed as prop */}
